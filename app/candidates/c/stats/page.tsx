...
import CLeaderboardTable from '../_components/CLeaderboardTable'
import type { BatterRow, BowlerRow, FielderRow } from '../_components/CLeaderboardTable'
import {
  CKicker,
  CPageHeader,
  CCard,
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, alignItems: 'center' }}>
      {recentSeasons.map((s) => {
        ...
        return (
          <Link
            key={s}
            href={`/candidates/c/stats?season=${s}`}
            style={{
              padding: '6px 14px',
              fontFamily: mono,
              fontSize: 11,
      ...
      <Link
        href={`/candidates/c/stats?season=${ALL_TIME}`}
        style={{
          padding: '6px 14px',
          fontFamily: mono,
          fontSize: 11,
            ...
            <div className="leaderboard-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 32, marginBottom: 56 }}>
              ...
              {batters.length > 0 && (
                <div>
                  ...
                  <CLeaderboardTable kind="batters" rows={batters} defaultSortKey="runs" basePath="/candidates/c/stats" />
                </div>
              )}
              ...
              {bowlers.length > 0 && (
                <div>
                  ...
                  <CLeaderboardTable kind="bowlers" rows={bowlers} defaultSortKey="wickets" basePath="/candidates/c/stats" />
                </div>
              )}
              ...
              {fielders.length > 0 && (
                <div>
                  ...
                  <CLeaderboardTable kind="fielders" rows={fielders} defaultSortKey="total" basePath="/candidates/c/stats" />
                </div>
              )}
            </div>
          </>
