...
import ScorecardTabs, { type InningsView, type ScBat, type ScBowl } from '../../_components/ScorecardTabs'
...
export default async function ScorecardPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-4">
        <Link href={`/candidates/d/fixtures?season=${fixture.season}`} className="text-xs text-emerald-700 hover:text-emerald-800 font-semibold no-underline">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <Link
              href={`/candidates/d/clubs/${clubSlug(fixture.opponent)}`}
