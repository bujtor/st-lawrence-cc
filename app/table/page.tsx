              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                <thead>
                  <tr style={{ borderBottom: `2px solid ${C_RULE}` }}>
                    <th style={{ padding: '10px 14px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'left', width: 32 }} scope="col">#</th>
                    <th style={{ padding: '10px 14px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'left' }} scope="col">Team</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Played">P</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Won">W</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Lost">L</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Tied">T</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Abandoned">A</th>
                    {anyCancelled && (
                      <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Cancelled">C</th>
                    )}
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Game points: Win 20, Tied 16, Abandoned/Cancelled 8">Game</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Batting bonus">Bat</th>
                    <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Bowling bonus">Bowl</th>
                    {anyPenalties && (
                      <th style={{ padding: '10px 10px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 600, textAlign: 'right' }} scope="col" title="Penalty points">Pen</th>
                    )}
                    <th style={{ padding: '10px 14px', fontFamily: mono, fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#999', fontWeight: 700, textAlign: 'right' }} scope="col">Pts</th>
                  </tr>
                </thead>
                <tbody>
                  {standings.map((t, i) => {
                    ...
                    return (
                      <tr key={t.team_id} style={{ background: rowBg }}>
                        ...
                        <td style={{
                          ...
                          {isPromotion && <span aria-hidden="true" style={{ marginRight: 3 }}>▲</span>}
                          {isRelegation && <span aria-hidden="true" style={{ marginRight: 3 }}>▼</span>}
                          {pos}
                        </td>
                        {/* Team name */}
                        <td style={{
                          ...
                          <Link
                            href={isOurs ? '/fixtures' : `/clubs/${clubSlug(clubLabel || teamLabel)}`}
                            style={{
                              display: 'block',
                              padding: '11px 14px',
                              color: 'inherit',
